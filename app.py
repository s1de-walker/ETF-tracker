...
if not error_flag:
    ...
    tickers = ["NIFTYBEES.NS", "NEXT50IETF.NS", "BANKBEES.NS", "MASPTOP50.NS", "MON100.NS", "MAFANG.NS", "GOLDBEES.NS", "SILVERETF.NS",
        "HDFCQUAL.NS", "LOWVOLIETF.NS", "MOMOMENTUM.NS", "HDFCGROWTH.NS", "MOVALUE.NS", "SMALLCAP.NS", "TOP100CASE.NS", "MNC.NS", "CONS.NS",
        "HEALTHIETF.NS", "LTGILTBEES.NS", "GSEC5IETF.NS", "CPSEETF.NS", "LIQUIDCASE.NS", "LIQUIDBEES.NS",
